...
public class VerticalViewPager extends ViewPager {
    ...
    private MotionEvent swapXYCoordinate(MotionEvent event)
    {
        // now we will swap x y coordinate using this
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        boolean intercepted = super.onInterceptTouchEvent ( swapXYCoordinate(ev) );

        swapXYCoordinate( ev ); // return touch coordinates
        return intercepted;
    }

    @Override
    public boolean onTouchEvent(MotionEvent ev) {
        return super.onTouchEvent ( swapXYCoordinate( ev ) );
    }
}
